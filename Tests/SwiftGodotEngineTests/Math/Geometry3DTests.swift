...
final class Geometry3DTests: GodotTestCase {
    ...
    func testBuildBoxPlanes () {
        ...
        XCTAssertEqual (extents.x, box [0].d)
        XCTAssertEqual (box [0].normal, Vector3 (x: 1, y: 0, z: 0))
        XCTAssertEqual (extents.x, box [1].d)
        XCTAssertEqual (box [1].normal, Vector3 (x: -1, y: 0, z: 0))
        XCTAssertEqual (extents.y, box [2].d)
        XCTAssertEqual (box [2].normal, Vector3 (x: 0, y: 1, z: 0))
        XCTAssertEqual (extents.y, box [3].d)
        XCTAssertEqual (box [3].normal, Vector3 (x: 0, y: -1, z: 0))
        XCTAssertEqual (extents.z, box [4].d)
        XCTAssertEqual (box [4].normal, Vector3 (x: 0, y: 0, z: 1))
        XCTAssertEqual (extents.z, box [5].d)
        XCTAssertEqual (box [5].normal, Vector3 (x: 0, y: 0, z: -1))
    }
