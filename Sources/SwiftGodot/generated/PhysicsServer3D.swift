...
open class PhysicsServer3D: Object {
    ...
    private static var className = StringName("PhysicsServer3D")
    ...
    public enum PinJointParam: Int64, CaseIterable {
    ...
    public enum HingeJointParam: Int64, CaseIterable {
    ...
    public enum HingeJointFlag: Int64, CaseIterable {
    ...
    public enum SliderJointParam: Int64, CaseIterable {
    ...
    public enum ConeTwistJointParam: Int64, CaseIterable {
    ...
    public enum G6DOFJointAxisParam: Int64, CaseIterable {
    ...
    public enum G6DOFJointAxisFlag: Int64, CaseIterable {
    ...
    public enum ShapeType: Int64, CaseIterable {
    ...
    public enum AreaParameter: Int64, CaseIterable {
    ...
    public enum AreaSpaceOverrideMode: Int64, CaseIterable {
    ...
    public enum BodyMode: Int64, CaseIterable {
    ...
    public enum BodyParameter: Int64, CaseIterable {
    ...
    public enum BodyDampMode: Int64, CaseIterable {
    ...
    public enum BodyState: Int64, CaseIterable {
    ...
    public enum AreaBodyStatus: Int64, CaseIterable {
    ...
    public enum BodyAxis: Int64, CaseIterable {
        /// 
    ...
    public static func worldBoundaryShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_world_boundary_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func separationRayShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_separation_ray_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_sphere_shape_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("sphere_shape_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func sphereShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_sphere_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_box_shape_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("box_shape_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func boxShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_box_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func capsuleShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_capsule_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_cylinder_shape_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("cylinder_shape_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func cylinderShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_cylinder_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func convexPolygonShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_convex_polygon_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func concavePolygonShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_concave_polygon_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_heightmap_shape_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("heightmap_shape_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func heightmapShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_heightmap_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_custom_shape_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("custom_shape_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func customShapeCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_custom_shape_create, shared.handle, nil, &_result.content)
        return _result
    }
            ...
            withUnsafePointer(to: data.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_shape_set_data, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_shape_set_margin: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("shape_set_margin")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func shapeSetMargin(shape: RID, margin: Double) {
        withUnsafePointer(to: shape.content) { pArg0 in
            withUnsafePointer(to: margin) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_shape_set_margin, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: shape.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_shape_get_type, shared.handle, pArgs, &_result)
                }
    ...
    public static func shapeGetData(shape: RID) -> Variant? {
        ...
        withUnsafePointer(to: shape.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_shape_get_data, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_shape_get_margin: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("shape_get_margin")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func shapeGetMargin(shape: RID) -> Double {
        ...
        withUnsafePointer(to: shape.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_shape_get_margin, shared.handle, pArgs, &_result)
                }
    ...
    public static func spaceCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_space_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func spaceSetActive(space: RID, active: Bool) {
        withUnsafePointer(to: space.content) { pArg0 in
            withUnsafePointer(to: active) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_space_set_active, shared.handle, pArgs, nil)
                    }
    ...
    public static func spaceIsActive(space: RID) -> Bool {
        ...
        withUnsafePointer(to: space.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_space_is_active, shared.handle, pArgs, &_result)
                }
                ...
                withUnsafePointer(to: value) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_space_set_param, shared.handle, pArgs, nil)
                        }
    ...
    public static func spaceGetParam(space: RID, param: PhysicsServer3D.SpaceParameter) -> Double {
        ...
        withUnsafePointer(to: space.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_space_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    public static func spaceGetDirectState(space: RID) -> PhysicsDirectSpaceState3D? {
        ...
        withUnsafePointer(to: space.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_space_get_direct_state, shared.handle, pArgs, &_result)
                }
    ...
    public static func areaCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_area_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func areaSetSpace(area: RID, space: RID) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: space.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_space, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaGetSpace(area: RID) -> RID {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_space, shared.handle, pArgs, &_result.content)
                }
                    ...
                    withUnsafePointer(to: disabled) { pArg3 in
                        withUnsafePointer(to: UnsafeRawPointersN4(pArg0, pArg1, pArg2, pArg3)) { pArgs in
                            pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 4) { pArgs in
                                gi.object_method_bind_ptrcall(method_area_add_shape, shared.handle, pArgs, nil)
                            }
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: shape.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_area_set_shape, shared.handle, pArgs, nil)
                        }
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: transform) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_area_set_shape_transform, shared.handle, pArgs, nil)
                        }
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: disabled) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_area_set_shape_disabled, shared.handle, pArgs, nil)
                        }
    ...
    public static func areaGetShapeCount(area: RID) -> Int32 {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_shape_count, shared.handle, pArgs, &_result)
                }
    ...
    public static func areaGetShape(area: RID, shapeIdx: Int32) -> RID {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_get_shape, shared.handle, pArgs, &_result.content)
                    }
    ...
    public static func areaGetShapeTransform(area: RID, shapeIdx: Int32) -> Transform3D {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_get_shape_transform, shared.handle, pArgs, &_result)
                    }
    ...
    public static func areaRemoveShape(area: RID, shapeIdx: Int32) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_remove_shape, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaClearShapes(area: RID) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_clear_shapes, shared.handle, pArgs, nil)
                }
    ...
    public static func areaSetCollisionLayer(area: RID, layer: UInt32) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: layer) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_collision_layer, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaGetCollisionLayer(area: RID) -> UInt32 {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_collision_layer, shared.handle, pArgs, &_result)
                }
    ...
    public static func areaSetCollisionMask(area: RID, mask: UInt32) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: mask) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_collision_mask, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaGetCollisionMask(area: RID) -> UInt32 {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_collision_mask, shared.handle, pArgs, &_result)
                }
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_area_set_param, shared.handle, pArgs, nil)
                        }
    ...
    public static func areaSetTransform(area: RID, transform: Transform3D) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: transform) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_transform, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaGetParam(area: RID, param: PhysicsServer3D.AreaParameter) -> Variant? {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    public static func areaGetTransform(area: RID) -> Transform3D {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_transform, shared.handle, pArgs, &_result)
                }
    ...
    public static func areaAttachObjectInstanceId(area: RID, id: UInt) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: id) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_attach_object_instance_id, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaGetObjectInstanceId(area: RID) -> UInt {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_area_get_object_instance_id, shared.handle, pArgs, &_result)
                }
    ...
    public static func areaSetMonitorCallback(area: RID, callback: Callable) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: callback.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_monitor_callback, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaSetAreaMonitorCallback(area: RID, callback: Callable) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: callback.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_area_monitor_callback, shared.handle, pArgs, nil)
                    }
    ...
    public static func areaSetMonitorable(area: RID, monitorable: Bool) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: monitorable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_monitorable, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_area_set_ray_pickable: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("area_set_ray_pickable")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1265174801)!
            }
    ...
    public static func areaSetRayPickable(area: RID, enable: Bool) {
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: enable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_set_ray_pickable, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_body_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func bodySetSpace(body: RID, space: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: space.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_space, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetSpace(body: RID) -> RID {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_space, shared.handle, pArgs, &_result.content)
                }
    ...
    public static func bodySetMode(body: RID, mode: PhysicsServer3D.BodyMode) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: mode.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_mode, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetMode(body: RID) -> PhysicsServer3D.BodyMode {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_mode, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetCollisionLayer(body: RID, layer: UInt32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: layer) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_collision_layer, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetCollisionLayer(body: RID) -> UInt32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_collision_layer, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetCollisionMask(body: RID, mask: UInt32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: mask) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_collision_mask, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetCollisionMask(body: RID) -> UInt32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_collision_mask, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetCollisionPriority(body: RID, priority: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: priority) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_collision_priority, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetCollisionPriority(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_collision_priority, shared.handle, pArgs, &_result)
                }
            ...
            withUnsafePointer(to: shape.content) { pArg1 in
                withUnsafePointer(to: transform) { pArg2 in
                    withUnsafePointer(to: disabled) { pArg3 in
                        withUnsafePointer(to: UnsafeRawPointersN4(pArg0, pArg1, pArg2, pArg3)) { pArgs in
                            pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 4) { pArgs in
                                gi.object_method_bind_ptrcall(method_body_add_shape, shared.handle, pArgs, nil)
                            }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: shape.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_shape, shared.handle, pArgs, nil)
                        }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: transform) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_shape_transform, shared.handle, pArgs, nil)
                        }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: disabled) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_shape_disabled, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyGetShapeCount(body: RID) -> Int32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_shape_count, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodyGetShape(body: RID, shapeIdx: Int32) -> RID {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_shape, shared.handle, pArgs, &_result.content)
                    }
    ...
    public static func bodyGetShapeTransform(body: RID, shapeIdx: Int32) -> Transform3D {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_shape_transform, shared.handle, pArgs, &_result)
                    }
    ...
    public static func bodyRemoveShape(body: RID, shapeIdx: Int32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: shapeIdx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_remove_shape, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyClearShapes(body: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_clear_shapes, shared.handle, pArgs, nil)
                }
    ...
    public static func bodyAttachObjectInstanceId(body: RID, id: UInt) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: id) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_attach_object_instance_id, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetObjectInstanceId(body: RID) -> UInt {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_object_instance_id, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_body_set_enable_continuous_collision_detection: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("body_set_enable_continuous_collision_detection")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1265174801)!
            }
    ...
    public static func bodySetEnableContinuousCollisionDetection(body: RID, enable: Bool) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: enable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_enable_continuous_collision_detection, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_body_is_continuous_collision_detection_enabled: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("body_is_continuous_collision_detection_enabled")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 4155700596)!
            }
    ...
    public static func bodyIsContinuousCollisionDetectionEnabled(body: RID) -> Bool {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_is_continuous_collision_detection_enabled, shared.handle, pArgs, &_result)
                }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_param, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyGetParam(body: RID, param: PhysicsServer3D.BodyParameter) -> Variant? {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    public static func bodyResetMassProperties(body: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_reset_mass_properties, shared.handle, pArgs, nil)
                }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: state.rawValue) { pArg1 in
                withUnsafePointer(to: value.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_state, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyGetState(body: RID, state: PhysicsServer3D.BodyState) -> Variant? {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: state.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_state, shared.handle, pArgs, &_result)
                    }
    ...
    public static func bodyApplyCentralImpulse(body: RID, impulse: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: impulse) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_apply_central_impulse, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: impulse) { pArg1 in
                withUnsafePointer(to: position) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_apply_impulse, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyApplyTorqueImpulse(body: RID, impulse: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: impulse) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_apply_torque_impulse, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyApplyCentralForce(body: RID, force: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: force) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_apply_central_force, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: force) { pArg1 in
                withUnsafePointer(to: position) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_apply_force, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyApplyTorque(body: RID, torque: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: torque) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_apply_torque, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyAddConstantCentralForce(body: RID, force: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: force) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_add_constant_central_force, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: force) { pArg1 in
                withUnsafePointer(to: position) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_add_constant_force, shared.handle, pArgs, nil)
                        }
    ...
    public static func bodyAddConstantTorque(body: RID, torque: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: torque) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_add_constant_torque, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodySetConstantForce(body: RID, force: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: force) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_constant_force, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetConstantForce(body: RID) -> Vector3 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_constant_force, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetConstantTorque(body: RID, torque: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: torque) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_constant_torque, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetConstantTorque(body: RID) -> Vector3 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_constant_torque, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetAxisVelocity(body: RID, axisVelocity: Vector3) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: axisVelocity) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_axis_velocity, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_body_set_axis_lock: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("body_set_axis_lock")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: lock) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_axis_lock, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_body_is_axis_locked: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("body_is_axis_locked")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func bodyIsAxisLocked(body: RID, axis: PhysicsServer3D.BodyAxis) -> Bool {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_is_axis_locked, shared.handle, pArgs, &_result)
                    }
    ...
    public static func bodyAddCollisionException(body: RID, exceptedBody: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: exceptedBody.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_add_collision_exception, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyRemoveCollisionException(body: RID, exceptedBody: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: exceptedBody.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_remove_collision_exception, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodySetMaxContactsReported(body: RID, amount: Int32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: amount) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_max_contacts_reported, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyGetMaxContactsReported(body: RID) -> Int32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_max_contacts_reported, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetOmitForceIntegration(body: RID, enable: Bool) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: enable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_omit_force_integration, shared.handle, pArgs, nil)
                    }
    ...
    public static func bodyIsOmittingForceIntegration(body: RID) -> Bool {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_is_omitting_force_integration, shared.handle, pArgs, &_result)
                }
    ...
    public static func bodySetStateSyncCallback(body: RID, callable: Callable) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: callable.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_state_sync_callback, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: callable.content) { pArg1 in
                withUnsafePointer(to: userdata.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_set_force_integration_callback, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_body_set_ray_pickable: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("body_set_ray_pickable")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1265174801)!
            }
    ...
    public static func bodySetRayPickable(body: RID, enable: Bool) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: enable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_set_ray_pickable, shared.handle, pArgs, nil)
                    }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: parameters?.handle) { pArg1 in
                withUnsafePointer(to: result?.handle) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_body_test_motion, shared.handle, pArgs, &_result)
                        }
    ...
    public static func bodyGetDirectState(body: RID) -> PhysicsDirectBodyState3D? {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_body_get_direct_state, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_create: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_create")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 529393457)!
            }
    ...
    public static func softBodyCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_soft_body_create, shared.handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_soft_body_update_rendering_server: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_update_rendering_server")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func softBodyUpdateRenderingServer(body: RID, renderingServerHandler: PhysicsServer3DRenderingServerHandler?) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: renderingServerHandler?.handle) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_update_rendering_server, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_set_space: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_space")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 395945892)!
            }
    ...
    public static func softBodySetSpace(body: RID, space: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: space.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_space, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_space: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_space")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3814569979)!
            }
    ...
    public static func softBodyGetSpace(body: RID) -> RID {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_space, shared.handle, pArgs, &_result.content)
                }
    ...
    fileprivate static let method_soft_body_set_mesh: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_mesh")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 395945892)!
            }
    ...
    public static func softBodySetMesh(body: RID, mesh: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: mesh.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_mesh, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_bounds: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_bounds")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func softBodyGetBounds(body: RID) -> AABB {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_bounds, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_collision_layer: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_collision_layer")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3411492887)!
            }
    ...
    public static func softBodySetCollisionLayer(body: RID, layer: UInt32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: layer) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_collision_layer, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_collision_layer: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_collision_layer")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2198884583)!
            }
    ...
    public static func softBodyGetCollisionLayer(body: RID) -> UInt32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_collision_layer, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_collision_mask: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_collision_mask")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3411492887)!
            }
    ...
    public static func softBodySetCollisionMask(body: RID, mask: UInt32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: mask) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_collision_mask, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_collision_mask: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_collision_mask")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2198884583)!
            }
    ...
    public static func softBodyGetCollisionMask(body: RID) -> UInt32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_collision_mask, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_add_collision_exception: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_add_collision_exception")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 395945892)!
            }
    ...
    public static func softBodyAddCollisionException(body: RID, bodyB: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: bodyB.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_add_collision_exception, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_remove_collision_exception: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_remove_collision_exception")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 395945892)!
            }
    ...
    public static func softBodyRemoveCollisionException(body: RID, bodyB: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: bodyB.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_remove_collision_exception, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_set_state: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_state")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 599977762)!
            }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: state.rawValue) { pArg1 in
                withUnsafePointer(to: variant.content) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_soft_body_set_state, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_soft_body_get_state: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_state")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1850449534)!
            }
    ...
    public static func softBodyGetState(body: RID, state: PhysicsServer3D.BodyState) -> Variant? {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: state.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_get_state, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_soft_body_set_transform: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_transform")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3935195649)!
            }
    ...
    public static func softBodySetTransform(body: RID, transform: Transform3D) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: transform) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_transform, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_set_ray_pickable: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_ray_pickable")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1265174801)!
            }
    ...
    public static func softBodySetRayPickable(body: RID, enable: Bool) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: enable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_ray_pickable, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_set_simulation_precision: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_simulation_precision")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3411492887)!
            }
    ...
    public static func softBodySetSimulationPrecision(body: RID, simulationPrecision: Int32) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: simulationPrecision) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_simulation_precision, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_simulation_precision: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_simulation_precision")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2198884583)!
            }
    ...
    public static func softBodyGetSimulationPrecision(body: RID) -> Int32 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_simulation_precision, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_total_mass: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_total_mass")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1794382983)!
            }
    ...
    public static func softBodySetTotalMass(body: RID, totalMass: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: totalMass) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_total_mass, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_total_mass: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_total_mass")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 866169185)!
            }
    ...
    public static func softBodyGetTotalMass(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_total_mass, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_linear_stiffness: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_linear_stiffness")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1794382983)!
            }
    ...
    public static func softBodySetLinearStiffness(body: RID, stiffness: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: stiffness) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_linear_stiffness, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_linear_stiffness: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_linear_stiffness")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 866169185)!
            }
    ...
    public static func softBodyGetLinearStiffness(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_linear_stiffness, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_pressure_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_pressure_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1794382983)!
            }
    ...
    public static func softBodySetPressureCoefficient(body: RID, pressureCoefficient: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: pressureCoefficient) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_pressure_coefficient, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_pressure_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_pressure_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 866169185)!
            }
    ...
    public static func softBodyGetPressureCoefficient(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_pressure_coefficient, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_damping_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_damping_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1794382983)!
            }
    ...
    public static func softBodySetDampingCoefficient(body: RID, dampingCoefficient: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: dampingCoefficient) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_damping_coefficient, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_damping_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_damping_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 866169185)!
            }
    ...
    public static func softBodyGetDampingCoefficient(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_damping_coefficient, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_set_drag_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_set_drag_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1794382983)!
            }
    ...
    public static func softBodySetDragCoefficient(body: RID, dragCoefficient: Double) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: dragCoefficient) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_set_drag_coefficient, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_soft_body_get_drag_coefficient: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_drag_coefficient")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 866169185)!
            }
    ...
    public static func softBodyGetDragCoefficient(body: RID) -> Double {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_get_drag_coefficient, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_soft_body_move_point: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_move_point")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: pointIndex) { pArg1 in
                withUnsafePointer(to: globalPosition) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_soft_body_move_point, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_soft_body_get_point_global_position: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_get_point_global_position")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func softBodyGetPointGlobalPosition(body: RID, pointIndex: Int32) -> Vector3 {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: pointIndex) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_get_point_global_position, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_soft_body_remove_all_pinned_points: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_remove_all_pinned_points")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2722037293)!
            }
    ...
    public static func softBodyRemoveAllPinnedPoints(body: RID) {
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_soft_body_remove_all_pinned_points, shared.handle, pArgs, nil)
                }
    ...
    fileprivate static let method_soft_body_pin_point: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_pin_point")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2658558584)!
            }
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: pointIndex) { pArg1 in
                withUnsafePointer(to: pin) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_soft_body_pin_point, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_soft_body_is_point_pinned: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("soft_body_is_point_pinned")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func softBodyIsPointPinned(body: RID, pointIndex: Int32) -> Bool {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: pointIndex) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_soft_body_is_point_pinned, shared.handle, pArgs, &_result)
                    }
    ...
    public static func jointCreate() -> RID {
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(method_joint_create, shared.handle, nil, &_result.content)
        return _result
    }
    ...
    public static func jointClear(joint: RID) {
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_joint_clear, shared.handle, pArgs, nil)
                }
                        ...
                        withUnsafePointer(to: localB) { pArg4 in
                            withUnsafePointer(to: UnsafeRawPointersN5(pArg0, pArg1, pArg2, pArg3, pArg4)) { pArgs in
                                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 5) { pArgs in
                                    gi.object_method_bind_ptrcall(method_joint_make_pin, shared.handle, pArgs, nil)
                                }
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_pin_joint_set_param, shared.handle, pArgs, nil)
                        }
    ...
    public static func pinJointGetParam(joint: RID, param: PhysicsServer3D.PinJointParam) -> Double {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_pin_joint_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_pin_joint_set_local_a: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("pin_joint_set_local_a")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3227306858)!
            }
    ...
    public static func pinJointSetLocalA(joint: RID, localA: Vector3) {
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: localA) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_pin_joint_set_local_a, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_pin_joint_get_local_a: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("pin_joint_get_local_a")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 531438156)!
            }
    ...
    public static func pinJointGetLocalA(joint: RID) -> Vector3 {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_pin_joint_get_local_a, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_pin_joint_set_local_b: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("pin_joint_set_local_b")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3227306858)!
            }
    ...
    public static func pinJointSetLocalB(joint: RID, localB: Vector3) {
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: localB) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_pin_joint_set_local_b, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_pin_joint_get_local_b: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("pin_joint_get_local_b")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 531438156)!
            }
    ...
    public static func pinJointGetLocalB(joint: RID) -> Vector3 {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_pin_joint_get_local_b, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_joint_make_hinge: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_make_hinge")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                ...
                withUnsafePointer(to: hingeA) { pArg2 in
                    withUnsafePointer(to: bodyB.content) { pArg3 in
                        withUnsafePointer(to: hingeB) { pArg4 in
                            withUnsafePointer(to: UnsafeRawPointersN5(pArg0, pArg1, pArg2, pArg3, pArg4)) { pArgs in
                                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 5) { pArgs in
                                    gi.object_method_bind_ptrcall(method_joint_make_hinge, shared.handle, pArgs, nil)
                                }
    ...
    fileprivate static let method_hinge_joint_set_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("hinge_joint_set_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_hinge_joint_set_param, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_hinge_joint_get_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("hinge_joint_get_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func hingeJointGetParam(joint: RID, param: PhysicsServer3D.HingeJointParam) -> Double {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_hinge_joint_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_hinge_joint_set_flag: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("hinge_joint_set_flag")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: flag.rawValue) { pArg1 in
                withUnsafePointer(to: enabled) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_hinge_joint_set_flag, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_hinge_joint_get_flag: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("hinge_joint_get_flag")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func hingeJointGetFlag(joint: RID, flag: PhysicsServer3D.HingeJointFlag) -> Bool {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: flag.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_hinge_joint_get_flag, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_joint_make_slider: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_make_slider")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1684107643)!
            }
                ...
                withUnsafePointer(to: localRefA) { pArg2 in
                    withUnsafePointer(to: bodyB.content) { pArg3 in
                        withUnsafePointer(to: localRefB) { pArg4 in
                            withUnsafePointer(to: UnsafeRawPointersN5(pArg0, pArg1, pArg2, pArg3, pArg4)) { pArgs in
                                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 5) { pArgs in
                                    gi.object_method_bind_ptrcall(method_joint_make_slider, shared.handle, pArgs, nil)
                                }
    ...
    fileprivate static let method_slider_joint_set_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("slider_joint_set_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_slider_joint_set_param, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_slider_joint_get_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("slider_joint_get_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func sliderJointGetParam(joint: RID, param: PhysicsServer3D.SliderJointParam) -> Double {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_slider_joint_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    fileprivate static let method_joint_make_cone_twist: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_make_cone_twist")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1684107643)!
            }
                ...
                withUnsafePointer(to: localRefA) { pArg2 in
                    withUnsafePointer(to: bodyB.content) { pArg3 in
                        withUnsafePointer(to: localRefB) { pArg4 in
                            withUnsafePointer(to: UnsafeRawPointersN5(pArg0, pArg1, pArg2, pArg3, pArg4)) { pArgs in
                                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 5) { pArgs in
                                    gi.object_method_bind_ptrcall(method_joint_make_cone_twist, shared.handle, pArgs, nil)
                                }
    ...
    fileprivate static let method_cone_twist_joint_set_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("cone_twist_joint_set_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: value) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_cone_twist_joint_set_param, shared.handle, pArgs, nil)
                        }
    ...
    fileprivate static let method_cone_twist_joint_get_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("cone_twist_joint_get_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public static func coneTwistJointGetParam(joint: RID, param: PhysicsServer3D.ConeTwistJointParam) -> Double {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_cone_twist_joint_get_param, shared.handle, pArgs, &_result)
                    }
    ...
    public static func jointGetType(joint: RID) -> PhysicsServer3D.JointType {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_joint_get_type, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_joint_set_solver_priority: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_set_solver_priority")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 3411492887)!
            }
    ...
    public static func jointSetSolverPriority(joint: RID, priority: Int32) {
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: priority) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_joint_set_solver_priority, shared.handle, pArgs, nil)
                    }
    ...
    fileprivate static let method_joint_get_solver_priority: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_get_solver_priority")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2198884583)!
            }
    ...
    public static func jointGetSolverPriority(joint: RID) -> Int32 {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_joint_get_solver_priority, shared.handle, pArgs, &_result)
                }
    ...
    public static func jointDisableCollisionsBetweenBodies(joint: RID, disable: Bool) {
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: disable) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_joint_disable_collisions_between_bodies, shared.handle, pArgs, nil)
                    }
    ...
    public static func jointIsDisabledCollisionsBetweenBodies(joint: RID) -> Bool {
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_joint_is_disabled_collisions_between_bodies, shared.handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_joint_make_generic_6dof: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("joint_make_generic_6dof")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1684107643)!
            }
                ...
                withUnsafePointer(to: localRefA) { pArg2 in
                    withUnsafePointer(to: bodyB.content) { pArg3 in
                        withUnsafePointer(to: localRefB) { pArg4 in
                            withUnsafePointer(to: UnsafeRawPointersN5(pArg0, pArg1, pArg2, pArg3, pArg4)) { pArgs in
                                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 5) { pArgs in
                                    gi.object_method_bind_ptrcall(method_joint_make_generic_6dof, shared.handle, pArgs, nil)
                                }
    ...
    fileprivate static let method_generic_6dof_joint_set_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("generic_6dof_joint_set_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
            ...
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: param.rawValue) { pArg2 in
                    withUnsafePointer(to: value) { pArg3 in
                        withUnsafePointer(to: UnsafeRawPointersN4(pArg0, pArg1, pArg2, pArg3)) { pArgs in
                            pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 4) { pArgs in
                                gi.object_method_bind_ptrcall(method_generic_6dof_joint_set_param, shared.handle, pArgs, nil)
                            }
    ...
    fileprivate static let method_generic_6dof_joint_get_param: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("generic_6dof_joint_get_param")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: param.rawValue) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_generic_6dof_joint_get_param, shared.handle, pArgs, &_result)
                        }
    ...
    fileprivate static let method_generic_6dof_joint_set_flag: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("generic_6dof_joint_set_flag")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
            ...
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: flag.rawValue) { pArg2 in
                    withUnsafePointer(to: enable) { pArg3 in
                        withUnsafePointer(to: UnsafeRawPointersN4(pArg0, pArg1, pArg2, pArg3)) { pArgs in
                            pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 4) { pArgs in
                                gi.object_method_bind_ptrcall(method_generic_6dof_joint_set_flag, shared.handle, pArgs, nil)
                            }
    ...
    fileprivate static let method_generic_6dof_joint_get_flag: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("generic_6dof_joint_get_flag")
        return withUnsafePointer(to: &PhysicsServer3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: joint.content) { pArg0 in
            withUnsafePointer(to: axis.rawValue) { pArg1 in
                withUnsafePointer(to: flag.rawValue) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(method_generic_6dof_joint_get_flag, shared.handle, pArgs, &_result)
                        }
    ...
    public static func setActive(_ active: Bool) {
        withUnsafePointer(to: active) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_set_active, shared.handle, pArgs, nil)
                }
    ...
    public static func getProcessInfo(_ processInfo: PhysicsServer3D.ProcessInfo) -> Int32 {
        ...
        withUnsafePointer(to: processInfo.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_get_process_info, shared.handle, pArgs, &_result)
                }
