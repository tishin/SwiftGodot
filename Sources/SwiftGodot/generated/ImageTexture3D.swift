...
open class ImageTexture3D: Texture3D {
    private static var className = StringName("ImageTexture3D")
    ...
    public final func create(format: Image.Format, width: Int32, height: Int32, depth: Int32, useMipmaps: Bool, data: TypedArray<Image?>) -> GodotError {
    ...
    public final func update(data: TypedArray<Image?>) {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
