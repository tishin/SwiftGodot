...
open class Image: Resource {
    ...
    public enum Interpolation: Int64, CaseIterable {
    ...
    public enum AlphaMode: Int64, CaseIterable {
    ...
    public enum CompressMode: Int64, CaseIterable {
    ...
    public enum UsedChannels: Int64, CaseIterable {
    ...
    public enum CompressSource: Int64, CaseIterable {
    ...
    public enum ASTCFormat: Int64, CaseIterable {
