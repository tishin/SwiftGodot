...
open class Tree: Control {
    ...
    public enum DropModeFlags: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var multiSelected: SignalWithArguments<TreeItem?, Int64, Bool> { SignalWithArguments<TreeItem?, Int64, Bool> (target: self, signalName: "multi_selected") }
    ...
    /// }
    /// ```
    public var itemMouseSelected: SignalWithArguments<Vector2, Int64> { SignalWithArguments<Vector2, Int64> (target: self, signalName: "item_mouse_selected") }
    ...
    /// }
    /// ```
    public var customItemClicked: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "custom_item_clicked") }
    ...
    /// }
    /// ```
    public var itemCollapsed: SignalWithArguments<TreeItem?> { SignalWithArguments<TreeItem?> (target: self, signalName: "item_collapsed") }
    ...
    /// }
    /// ```
    public var checkPropagatedToItem: SignalWithArguments<TreeItem?, Int64> { SignalWithArguments<TreeItem?, Int64> (target: self, signalName: "check_propagated_to_item") }
    ...
    /// }
    /// ```
    public var buttonClicked: SignalWithArguments<TreeItem?, Int64, Int64, Int64> { SignalWithArguments<TreeItem?, Int64, Int64, Int64> (target: self, signalName: "button_clicked") }
    ...
    /// }
    /// ```
    public var customPopupEdited: SignalWithArguments<Bool> { SignalWithArguments<Bool> (target: self, signalName: "custom_popup_edited") }
    ...
    /// }
    /// ```
    public var columnTitleClicked: SignalWithArguments<Int64, Int64> { SignalWithArguments<Int64, Int64> (target: self, signalName: "column_title_clicked") }
