...
open class HTTPRequest: Node {
    ...
    /// }
    /// ```
    public var requestCompleted: SignalWithArguments<Int64, Int64, PackedStringArray, PackedByteArray> { SignalWithArguments<Int64, Int64, PackedStringArray, PackedByteArray> (target: self, signalName: "request_completed") }
