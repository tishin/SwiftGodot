...
open class Viewport: Node {
    ...
    public enum Scaling3DMode: Int64, CaseIterable {
    ...
    public enum RenderInfo: Int64, CaseIterable {
    ...
    public enum RenderInfoType: Int64, CaseIterable {
    ...
    public enum DebugDraw: Int64, CaseIterable {
    ...
    public enum DefaultCanvasItemTextureFilter: Int64, CaseIterable {
    ...
    public enum DefaultCanvasItemTextureRepeat: Int64, CaseIterable {
    ...
    public enum SDFOversize: Int64, CaseIterable {
    ...
    public enum SDFScale: Int64, CaseIterable {
    ...
    public enum VRSMode: Int64, CaseIterable {
    ...
    public enum VRSUpdateMode: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var guiFocusChanged: SignalWithArguments<Control?> { SignalWithArguments<Control?> (target: self, signalName: "gui_focus_changed") }
