...
open class StreamPeerGZIP: StreamPeer {
    private static var className = StringName("StreamPeerGZIP")
    override open class var godotClassName: StringName { className }
    /* Methods */
    fileprivate static let method_start_compression: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("start_compression")
    ...
    fileprivate static let method_start_decompression: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("start_decompression")
        return withUnsafePointer(to: &StreamPeerGZIP.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 781582770)!
            }
