...
open class VisualShaderNodeUIntOp: VisualShaderNode {
    private static var className = StringName("VisualShaderNodeUIntOp")
        ...
        withUnsafePointer(to: op.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(VisualShaderNodeUIntOp.method_set_operator, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_operator() -> VisualShaderNodeUIntOp.Operator {
        ...
        gi.object_method_bind_ptrcall(VisualShaderNodeUIntOp.method_get_operator, handle, nil, &_result)
