...
open class XRServer: Object {
    ...
    /// }
    /// ```
    public var trackerAdded: SignalWithArguments<StringName, Int64> { SignalWithArguments<StringName, Int64> (target: self, signalName: "tracker_added") }
    ...
    /// }
    /// ```
    public var trackerUpdated: SignalWithArguments<StringName, Int64> { SignalWithArguments<StringName, Int64> (target: self, signalName: "tracker_updated") }
    ...
    /// }
    /// ```
    public var trackerRemoved: SignalWithArguments<StringName, Int64> { SignalWithArguments<StringName, Int64> (target: self, signalName: "tracker_removed") }
