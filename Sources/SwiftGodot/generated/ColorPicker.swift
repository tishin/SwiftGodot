...
open class ColorPicker: VBoxContainer {
    ...
    public enum PickerShapeType: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var presetAdded: SignalWithArguments<Color> { SignalWithArguments<Color> (target: self, signalName: "preset_added") }
    ...
    /// }
    /// ```
    public var presetRemoved: SignalWithArguments<Color> { SignalWithArguments<Color> (target: self, signalName: "preset_removed") }
