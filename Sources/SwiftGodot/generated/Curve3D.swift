...
open class Curve3D: Resource {
    ...
    fileprivate final func get_point_count() -> Int32 {
        ...
        var _result: Int32 = 0
        gi.object_method_bind_ptrcall(Curve3D.method_get_point_count, handle, nil, &_result)
        return _result
    }
        ...
        withUnsafePointer(to: count) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_set_point_count, handle, pArgs, nil)
                }
                    ...
                    withUnsafePointer(to: index) { pArg3 in
                        withUnsafePointer(to: UnsafeRawPointersN4(pArg0, pArg1, pArg2, pArg3)) { pArgs in
                            pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 4) { pArgs in
                                gi.object_method_bind_ptrcall(Curve3D.method_add_point, handle, pArgs, nil)
                            }
            ...
            withUnsafePointer(to: position) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_set_point_position, handle, pArgs, nil)
                    }
    ...
    public final func getPointPosition(idx: Int32) -> Vector3 {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_point_position, handle, pArgs, &_result)
                }
    ...
    public final func setPointTilt(idx: Int32, tilt: Double) {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: tilt) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_set_point_tilt, handle, pArgs, nil)
                    }
    ...
    public final func getPointTilt(idx: Int32) -> Double {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_point_tilt, handle, pArgs, &_result)
                }
    ...
    public final func setPointIn(idx: Int32, position: Vector3) {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: position) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_set_point_in, handle, pArgs, nil)
                    }
    ...
    public final func getPointIn(idx: Int32) -> Vector3 {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_point_in, handle, pArgs, &_result)
                }
    ...
    public final func setPointOut(idx: Int32, position: Vector3) {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: position) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_set_point_out, handle, pArgs, nil)
                    }
    ...
    public final func getPointOut(idx: Int32) -> Vector3 {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_point_out, handle, pArgs, &_result)
                }
    ...
    public final func removePoint(idx: Int32) {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_remove_point, handle, pArgs, nil)
                }
    ...
    public final func clearPoints() {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        gi.object_method_bind_ptrcall(Curve3D.method_clear_points, handle, nil, nil)
    ...
    public final func sample(idx: Int32, t: Double) -> Vector3 {
        ...
        withUnsafePointer(to: idx) { pArg0 in
            withUnsafePointer(to: t) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_sample, handle, pArgs, &_result)
                    }
    ...
    public final func samplef(fofs: Double) -> Vector3 {
        ...
        withUnsafePointer(to: fofs) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_samplef, handle, pArgs, &_result)
                }
    ...
    fileprivate final func set_closed(_ closed: Bool) {
        ...
        withUnsafePointer(to: closed) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_set_closed, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_closed() -> Bool {
        ...
        gi.object_method_bind_ptrcall(Curve3D.method_is_closed, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_bake_interval(_ distance: Double) {
        ...
        withUnsafePointer(to: distance) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_set_bake_interval, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_bake_interval() -> Double {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall(Curve3D.method_get_bake_interval, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_up_vector_enabled(_ enable: Bool) {
        ...
        withUnsafePointer(to: enable) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_set_up_vector_enabled, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_up_vector_enabled() -> Bool {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Bool = false
        gi.object_method_bind_ptrcall(Curve3D.method_is_up_vector_enabled, handle, nil, &_result)
        return _result
    }
    ...
    public final func getBakedLength() -> Double {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall(Curve3D.method_get_baked_length, handle, nil, &_result)
        return _result
    }
    ...
    public final func sampleBaked(offset: Double = 0.0, cubic: Bool = false) -> Vector3 {
        ...
        withUnsafePointer(to: offset) { pArg0 in
            withUnsafePointer(to: cubic) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_sample_baked, handle, pArgs, &_result)
                    }
                ...
                withUnsafePointer(to: applyTilt) { pArg2 in
                    withUnsafePointer(to: UnsafeRawPointersN3(pArg0, pArg1, pArg2)) { pArgs in
                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 3) { pArgs in
                            gi.object_method_bind_ptrcall(Curve3D.method_sample_baked_with_rotation, handle, pArgs, &_result)
                        }
    ...
    public final func sampleBakedUpVector(offset: Double, applyTilt: Bool = false) -> Vector3 {
        ...
        withUnsafePointer(to: offset) { pArg0 in
            withUnsafePointer(to: applyTilt) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_sample_baked_up_vector, handle, pArgs, &_result)
                    }
    ...
    public final func getBakedPoints() -> PackedVector3Array {
        ...
        gi.object_method_bind_ptrcall(Curve3D.method_get_baked_points, handle, nil, &_result.content)
        return _result
    }
    ...
    public final func getBakedTilts() -> PackedFloat32Array {
        ...
        gi.object_method_bind_ptrcall(Curve3D.method_get_baked_tilts, handle, nil, &_result.content)
        return _result
    }
    ...
    public final func getBakedUpVectors() -> PackedVector3Array {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        let _result: PackedVector3Array = PackedVector3Array ()
        gi.object_method_bind_ptrcall(Curve3D.method_get_baked_up_vectors, handle, nil, &_result.content)
        return _result
    }
    ...
    public final func getClosestPoint(toPoint: Vector3) -> Vector3 {
        ...
        withUnsafePointer(to: toPoint) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_closest_point, handle, pArgs, &_result)
                }
    ...
    public final func getClosestOffset(toPoint: Vector3) -> Double {
        ...
        withUnsafePointer(to: toPoint) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Curve3D.method_get_closest_offset, handle, pArgs, &_result)
                }
    ...
    public final func tessellate(maxStages: Int32 = 5, toleranceDegrees: Double = 4) -> PackedVector3Array {
        ...
        withUnsafePointer(to: maxStages) { pArg0 in
            withUnsafePointer(to: toleranceDegrees) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_tessellate, handle, pArgs, &_result.content)
                    }
    ...
    public final func tessellateEvenLength(maxStages: Int32 = 5, toleranceLength: Double = 0.2) -> PackedVector3Array {
        ...
        withUnsafePointer(to: maxStages) { pArg0 in
            withUnsafePointer(to: toleranceLength) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Curve3D.method_tessellate_even_length, handle, pArgs, &_result.content)
                    }
