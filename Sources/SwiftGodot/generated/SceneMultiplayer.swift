...
open class SceneMultiplayer: MultiplayerAPI {
    ...
    /// }
    /// ```
    public var peerAuthenticating: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "peer_authenticating") }
    ...
    /// }
    /// ```
    public var peerAuthenticationFailed: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "peer_authentication_failed") }
    ...
    /// }
    /// ```
    public var peerPacket: SignalWithArguments<Int64, PackedByteArray> { SignalWithArguments<Int64, PackedByteArray> (target: self, signalName: "peer_packet") }
