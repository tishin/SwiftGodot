...
open class Environment: Resource {
    ...
    public enum AmbientSource: Int64, CaseIterable {
    ...
    public enum ReflectionSource: Int64, CaseIterable {
    ...
    public enum FogMode: Int64, CaseIterable {
    ...
    public enum SDFGIYScale: Int64, CaseIterable {
