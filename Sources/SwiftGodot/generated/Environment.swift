...
open class Environment: Resource {
    ...
    /// The fog's depth end distance from the camera. If this value is set to `0`, it will be equal to the current camera's ``Camera3D/far`` value. Only available when ``fogMode`` is set to .depth.
