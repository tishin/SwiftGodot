...
open class ENetMultiplayerPeer: MultiplayerPeer {
    private static var className = StringName("ENetMultiplayerPeer")
    ...
    fileprivate static let method_add_mesh_peer: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("add_mesh_peer")
        return withUnsafePointer(to: &ENetMultiplayerPeer.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    fileprivate static let method_set_bind_ip: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("set_bind_ip")
        return withUnsafePointer(to: &ENetMultiplayerPeer.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    fileprivate static let method_get_host: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_host")
        return withUnsafePointer(to: &ENetMultiplayerPeer.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
