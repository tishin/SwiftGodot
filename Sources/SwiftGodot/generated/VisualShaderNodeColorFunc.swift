...
open class VisualShaderNodeColorFunc: VisualShaderNode {
        ...
        withUnsafePointer(to: `func`.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(VisualShaderNodeColorFunc.method_set_function, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_function() -> VisualShaderNodeColorFunc.Function {
        ...
        gi.object_method_bind_ptrcall(VisualShaderNodeColorFunc.method_get_function, handle, nil, &_result)
