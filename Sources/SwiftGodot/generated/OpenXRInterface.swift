...
open class OpenXRInterface: XRInterface {
    ...
    public enum HandMotionRange: Int64, CaseIterable {
    ...
    public enum HandTrackedSource: Int64, CaseIterable {
    ...
    public enum HandJoints: Int64, CaseIterable {
        /// Palm joint.
    ...
    /// }
    /// ```
    public var refreshRateChanged: SignalWithArguments<Double> { SignalWithArguments<Double> (target: self, signalName: "refresh_rate_changed") }
