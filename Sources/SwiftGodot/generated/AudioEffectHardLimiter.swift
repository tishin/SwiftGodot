...
open class AudioEffectHardLimiter: AudioEffect {
    private static var className = StringName("AudioEffectHardLimiter")
    ...
    fileprivate static let method_set_pre_gain_db: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("set_pre_gain_db")
        return withUnsafePointer(to: &AudioEffectHardLimiter.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 373806689)!
            }
    ...
    fileprivate static let method_get_pre_gain_db: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_pre_gain_db")
        return withUnsafePointer(to: &AudioEffectHardLimiter.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1740695150)!
            }
    ...
    fileprivate static let method_set_release: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("set_release")
        return withUnsafePointer(to: &AudioEffectHardLimiter.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 373806689)!
            }
    ...
    fileprivate static let method_get_release: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_release")
        return withUnsafePointer(to: &AudioEffectHardLimiter.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1740695150)!
            }
