...
open class Window: Viewport {
    ...
    public enum ContentScaleAspect: Int64, CaseIterable {
    ...
    public enum ContentScaleStretch: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var windowInput: SignalWithArguments<InputEvent?> { SignalWithArguments<InputEvent?> (target: self, signalName: "window_input") }
    ...
    /// }
    /// ```
    public var filesDropped: SignalWithArguments<PackedStringArray> { SignalWithArguments<PackedStringArray> (target: self, signalName: "files_dropped") }
