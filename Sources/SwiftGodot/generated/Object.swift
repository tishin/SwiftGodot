...
open class Object: Wrapped {
    ...
    public final func get(property: StringName) -> Variant {
        ...
        withUnsafePointer(to: property.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Object.method_get, UnsafeMutableRawPointer(mutating: handle), pArgs, &_result.content)
                }
    ...
    public final func getIndexed(propertyPath: NodePath) -> Variant {
        ...
        withUnsafePointer(to: propertyPath.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Object.method_get_indexed, UnsafeMutableRawPointer(mutating: handle), pArgs, &_result.content)
                }
    ...
    public final func propertyGetRevert(property: StringName) -> Variant {
        ...
        withUnsafePointer(to: property.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(Object.method_property_get_revert, UnsafeMutableRawPointer(mutating: handle), pArgs, &_result.content)
                }
    ...
    public final func getMeta(name: StringName, `default`: Variant) -> Variant {
        ...
        withUnsafePointer(to: name.content) { pArg0 in
            withUnsafePointer(to: `default`.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Object.method_get_meta, UnsafeMutableRawPointer(mutating: handle), pArgs, &_result.content)
                    }
    ...
    public final func callv(method: StringName, argArray: GArray) -> Variant {
        ...
        withUnsafePointer(to: method.content) { pArg0 in
            withUnsafePointer(to: argArray.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(Object.method_callv, UnsafeMutableRawPointer(mutating: handle), pArgs, &_result.content)
                    }
