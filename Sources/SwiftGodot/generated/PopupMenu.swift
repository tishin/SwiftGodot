...
open class PopupMenu: Popup {
    ...
    /// }
    /// ```
    public var idPressed: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "id_pressed") }
    ...
    /// }
    /// ```
    public var idFocused: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "id_focused") }
    ...
    /// }
    /// ```
    public var indexPressed: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "index_pressed") }
