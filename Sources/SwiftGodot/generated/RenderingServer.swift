...
open class RenderingServer: Object {
    ...
    public enum CanvasItemTextureFilter: Int64, CaseIterable, CustomDebugStringConvertible {
        ...
        /// 
        /// > Note: This texture filter is rarely useful in 2D projects. .nearestWithMipmaps is usually more appropriate in this case.
        /// 
        ...
        /// 
        /// > Note: This texture filter is rarely useful in 2D projects. .linearWithMipmaps is usually more appropriate in this case.
        /// 
    ...
    public static func shaderGetParameterDefault(shader: RID, name: StringName) -> Variant {
        ...
        withUnsafePointer(to: shader.content) { pArg0 in
            withUnsafePointer(to: name.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_shader_get_parameter_default, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    public static func materialGetParam(material: RID, parameter: StringName) -> Variant {
        ...
        withUnsafePointer(to: material.content) { pArg0 in
            withUnsafePointer(to: parameter.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_material_get_param, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    /// 
    /// If set to ``RenderingServer/ViewportVRSUpdateMode/viewportVrsUpdateOnce``, the input texture is copied once and the mode is changed to ``RenderingServer/ViewportVRSUpdateMode/viewportVrsUpdateDisabled``.
    /// 
    ...
    public static func instanceGeometryGetShaderParameter(instance: RID, parameter: StringName) -> Variant {
        ...
        withUnsafePointer(to: instance.content) { pArg0 in
            withUnsafePointer(to: parameter.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_instance_geometry_get_shader_parameter, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    public static func instanceGeometryGetShaderParameterDefaultValue(instance: RID, parameter: StringName) -> Variant {
        ...
        withUnsafePointer(to: instance.content) { pArg0 in
            withUnsafePointer(to: parameter.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_instance_geometry_get_shader_parameter_default_value, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    public static func globalShaderParameterGet(name: StringName) -> Variant {
        ...
        withUnsafePointer(to: name.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_global_shader_parameter_get, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                }
