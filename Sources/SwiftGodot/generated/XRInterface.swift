...
open class XRInterface: RefCounted {
    ...
    public enum TrackingStatus: Int64, CaseIterable {
    ...
    public enum PlayAreaMode: Int64, CaseIterable {
    ...
    public enum EnvironmentBlendMode: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var playAreaChanged: SignalWithArguments<Int64> { SignalWithArguments<Int64> (target: self, signalName: "play_area_changed") }
