...
open class StaticBody2D: PhysicsBody2D {
        ...
        withUnsafePointer(to: vel) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(StaticBody2D.method_set_constant_linear_velocity, handle, pArgs, nil)
                }
    ...
    fileprivate final func set_constant_angular_velocity(_ vel: Double) {
        ...
        withUnsafePointer(to: vel) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(StaticBody2D.method_set_constant_angular_velocity, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_constant_linear_velocity() -> Vector2 {
        ...
        gi.object_method_bind_ptrcall(StaticBody2D.method_get_constant_linear_velocity, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func get_constant_angular_velocity() -> Double {
        ...
        gi.object_method_bind_ptrcall(StaticBody2D.method_get_constant_angular_velocity, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_physics_material_override(_ physicsMaterialOverride: PhysicsMaterial?) {
        ...
        withUnsafePointer(to: physicsMaterialOverride?.handle) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(StaticBody2D.method_set_physics_material_override, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_physics_material_override() -> PhysicsMaterial? {
        ...
        gi.object_method_bind_ptrcall(StaticBody2D.method_get_physics_material_override, handle, nil, &_result)
