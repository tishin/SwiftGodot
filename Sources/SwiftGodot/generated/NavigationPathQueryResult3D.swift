...
open class NavigationPathQueryResult3D: RefCounted {
        ...
        withUnsafePointer(to: path.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_set_path, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_path() -> PackedVector3Array {
        ...
        gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_get_path, handle, nil, &_result.content)
        return _result
    }
    ...
    fileprivate final func set_path_types(_ pathTypes: PackedInt32Array) {
        ...
        withUnsafePointer(to: pathTypes.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_set_path_types, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_path_types() -> PackedInt32Array {
        ...
        gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_get_path_types, handle, nil, &_result.content)
        return _result
    }
    ...
    fileprivate final func set_path_rids(_ pathRids: TypedArray<RID>) {
        ...
        withUnsafePointer(to: pathRids.array.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_set_path_rids, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_path_rids() -> TypedArray<RID> {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Int64 = 0
        gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_get_path_rids, handle, nil, &_result)
    ...
    fileprivate final func set_path_owner_ids(_ pathOwnerIds: PackedInt64Array) {
        ...
        withUnsafePointer(to: pathOwnerIds.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_set_path_owner_ids, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_path_owner_ids() -> PackedInt64Array {
        ...
        gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_get_path_owner_ids, handle, nil, &_result.content)
        return _result
    }
    ...
    public final func reset() {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        gi.object_method_bind_ptrcall(NavigationPathQueryResult3D.method_reset, handle, nil, nil)
