...
open class RichTextLabel: Control {
    ...
    public enum MetaUnderline: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var metaClicked: SimpleSignal { SimpleSignal (target: self, signalName: "meta_clicked") }
    ...
    /// }
    /// ```
    public var metaHoverStarted: SimpleSignal { SimpleSignal (target: self, signalName: "meta_hover_started") }
