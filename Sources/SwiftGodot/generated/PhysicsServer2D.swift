...
open class PhysicsServer2D: Object {
    ...
    public static func shapeGetData(shape: RID) -> Variant {
        ...
        withUnsafePointer(to: shape.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_shape_get_data, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                }
    ...
    public static func areaGetParam(area: RID, param: PhysicsServer2D.AreaParameter) -> Variant {
        ...
        withUnsafePointer(to: area.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_area_get_param, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    /// Creates a 2D body object in the physics server, and returns the ``RID`` that identifies it. The default settings for the created area include a collision layer and mask set to `1`, and body mode set to .rigid.
    /// 
    ...
    public static func bodyGetParam(body: RID, param: PhysicsServer2D.BodyParameter) -> Variant {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: param.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_param, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    public static func bodyGetState(body: RID, state: PhysicsServer2D.BodyState) -> Variant {
        ...
        withUnsafePointer(to: body.content) { pArg0 in
            withUnsafePointer(to: state.rawValue) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_body_get_state, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
