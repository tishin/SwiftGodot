...
open class NinePatchRect: Control {
        ...
        withUnsafePointer(to: texture?.handle) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_set_texture, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_texture() -> Texture2D? {
        ...
        gi.object_method_bind_ptrcall(NinePatchRect.method_get_texture, handle, nil, &_result)
            ...
            withUnsafePointer(to: value) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(NinePatchRect.method_set_patch_margin, handle, pArgs, nil)
                    }
    ...
    fileprivate final func get_patch_margin(_ margin: Side) -> Int32 {
        ...
        withUnsafePointer(to: margin.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_get_patch_margin, handle, pArgs, &_result)
                }
    ...
    fileprivate final func set_region_rect(_ rect: Rect2) {
        ...
        withUnsafePointer(to: rect) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_set_region_rect, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_region_rect() -> Rect2 {
        ...
        gi.object_method_bind_ptrcall(NinePatchRect.method_get_region_rect, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_draw_center(_ drawCenter: Bool) {
        ...
        withUnsafePointer(to: drawCenter) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_set_draw_center, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_draw_center_enabled() -> Bool {
        ...
        gi.object_method_bind_ptrcall(NinePatchRect.method_is_draw_center_enabled, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_h_axis_stretch_mode(_ mode: NinePatchRect.AxisStretchMode) {
        ...
        withUnsafePointer(to: mode.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_set_h_axis_stretch_mode, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_h_axis_stretch_mode() -> NinePatchRect.AxisStretchMode {
        ...
        gi.object_method_bind_ptrcall(NinePatchRect.method_get_h_axis_stretch_mode, handle, nil, &_result)
    ...
    fileprivate final func set_v_axis_stretch_mode(_ mode: NinePatchRect.AxisStretchMode) {
        ...
        withUnsafePointer(to: mode.rawValue) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NinePatchRect.method_set_v_axis_stretch_mode, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_v_axis_stretch_mode() -> NinePatchRect.AxisStretchMode {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Int64 = 0 // to avoid packed enums on the stack
        gi.object_method_bind_ptrcall(NinePatchRect.method_get_v_axis_stretch_mode, handle, nil, &_result)
        return NinePatchRect.AxisStretchMode (rawValue: _result)!
    }
