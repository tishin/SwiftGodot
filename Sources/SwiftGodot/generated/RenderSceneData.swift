...
open class RenderSceneData: Object {
    ...
    public final func getCamTransform() -> Transform3D {
        ...
        gi.object_method_bind_ptrcall(RenderSceneData.method_get_cam_transform, handle, nil, &_result)
        return _result
    }
    ...
    public final func getCamProjection() -> Projection {
        ...
        gi.object_method_bind_ptrcall(RenderSceneData.method_get_cam_projection, handle, nil, &_result)
        return _result
    }
    ...
    public final func getViewCount() -> UInt32 {
        ...
        gi.object_method_bind_ptrcall(RenderSceneData.method_get_view_count, handle, nil, &_result)
        return _result
    }
        ...
        withUnsafePointer(to: view) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RenderSceneData.method_get_view_eye_offset, handle, pArgs, &_result)
                }
    ...
    public final func getViewProjection(view: UInt32) -> Projection {
        ...
        withUnsafePointer(to: view) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(RenderSceneData.method_get_view_projection, handle, pArgs, &_result)
                }
    ...
    public final func getUniformBuffer() -> RID {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(RenderSceneData.method_get_uniform_buffer, handle, nil, &_result.content)
        return _result
    }
