...
open class ProjectSettings: Object {
    ...
    public static func getSetting(name: String, defaultValue: Variant) -> Variant {
        ...
        withUnsafePointer(to: name.content) { pArg0 in
            withUnsafePointer(to: defaultValue.content) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_get_setting, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    public static func getSettingWithOverride(name: StringName) -> Variant {
        ...
        withUnsafePointer(to: name.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(method_get_setting_with_override, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                }
