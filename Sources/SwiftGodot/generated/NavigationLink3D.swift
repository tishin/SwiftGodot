...
open class NavigationLink3D: Node3D {
    ...
    public final func getRid() -> RID {
        ...
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_rid, handle, nil, &_result.content)
        return _result
    }
        ...
        withUnsafePointer(to: enabled) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_enabled, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_enabled() -> Bool {
        ...
        gi.object_method_bind_ptrcall(NavigationLink3D.method_is_enabled, handle, nil, &_result)
        return _result
    }
    ...
    public final func setNavigationMap(_ navigationMap: RID) {
        ...
        withUnsafePointer(to: navigationMap.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_navigation_map, handle, pArgs, nil)
                }
    ...
    public final func getNavigationMap() -> RID {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_navigation_map, handle, nil, &_result.content)
        return _result
    }
    ...
    fileprivate final func set_bidirectional(_ bidirectional: Bool) {
        ...
        withUnsafePointer(to: bidirectional) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_bidirectional, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_bidirectional() -> Bool {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Bool = false
        gi.object_method_bind_ptrcall(NavigationLink3D.method_is_bidirectional, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_navigation_layers(_ navigationLayers: UInt32) {
        ...
        withUnsafePointer(to: navigationLayers) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_navigation_layers, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_navigation_layers() -> UInt32 {
        ...
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_navigation_layers, handle, nil, &_result)
        return _result
    }
            ...
            withUnsafePointer(to: value) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(NavigationLink3D.method_set_navigation_layer_value, handle, pArgs, nil)
                    }
    ...
    public final func getNavigationLayerValue(layerNumber: Int32) -> Bool {
        ...
        withUnsafePointer(to: layerNumber) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_get_navigation_layer_value, handle, pArgs, &_result)
                }
    ...
    fileprivate final func set_start_position(_ position: Vector3) {
        ...
        withUnsafePointer(to: position) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_start_position, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_start_position() -> Vector3 {
        ...
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_start_position, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_end_position(_ position: Vector3) {
        ...
        withUnsafePointer(to: position) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_end_position, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_end_position() -> Vector3 {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Vector3 = Vector3 ()
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_end_position, handle, nil, &_result)
        return _result
    }
    ...
    public final func setGlobalStartPosition(_ position: Vector3) {
        ...
        withUnsafePointer(to: position) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_global_start_position, handle, pArgs, nil)
                }
    ...
    public final func getGlobalStartPosition() -> Vector3 {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Vector3 = Vector3 ()
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_global_start_position, handle, nil, &_result)
        return _result
    }
    ...
    public final func setGlobalEndPosition(_ position: Vector3) {
        ...
        withUnsafePointer(to: position) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_global_end_position, handle, pArgs, nil)
                }
    ...
    public final func getGlobalEndPosition() -> Vector3 {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Vector3 = Vector3 ()
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_global_end_position, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_enter_cost(_ enterCost: Double) {
        ...
        withUnsafePointer(to: enterCost) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_enter_cost, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_enter_cost() -> Double {
        ...
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_enter_cost, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_travel_cost(_ travelCost: Double) {
        ...
        withUnsafePointer(to: travelCost) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationLink3D.method_set_travel_cost, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_travel_cost() -> Double {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall(NavigationLink3D.method_get_travel_cost, handle, nil, &_result)
        return _result
    }
