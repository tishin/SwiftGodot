...
/// 
/// A sphere shape collision that interacts with ``SpringBoneSimulator3D``.
open class SpringBoneCollisionSphere3D: SpringBoneCollision3D {
    private static var className = StringName("SpringBoneCollisionSphere3D")
    ...
    fileprivate static let method_set_radius: GDExtensionMethodBindPtr = {
        ...
        return withUnsafePointer(to: &SpringBoneCollisionSphere3D.godotClassName.content) { classPtr in
        ...
        withUnsafePointer(to: radius) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(SpringBoneCollisionSphere3D.method_set_radius, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func get_radius() -> Double {
        ...
        gi.object_method_bind_ptrcall(SpringBoneCollisionSphere3D.method_get_radius, UnsafeMutableRawPointer(mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_inside(_ enabled: Bool) {
        ...
        withUnsafePointer(to: enabled) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(SpringBoneCollisionSphere3D.method_set_inside, UnsafeMutableRawPointer(mutating: handle), pArgs, nil)
                }
    ...
    fileprivate final func is_inside() -> Bool {
        ...
        gi.object_method_bind_ptrcall(SpringBoneCollisionSphere3D.method_is_inside, UnsafeMutableRawPointer(mutating: handle), nil, &_result)
        return _result
    }
