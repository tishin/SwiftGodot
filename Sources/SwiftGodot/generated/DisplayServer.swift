...
open class DisplayServer: Object {
    ...
    public static func globalMenuGetItemTag(menuRoot: String, idx: Int32) -> Variant {
        ...
        withUnsafePointer(to: menuRoot.content) { pArg0 in
            withUnsafePointer(to: idx) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(method_global_menu_get_item_tag, UnsafeMutableRawPointer(mutating: shared.handle), pArgs, &_result.content)
                    }
    ...
    /// 
    /// > Note: This method is implemented if the display server has the .nativeDialog feature. Supported platforms include macOS and Windows.
    /// 
    ...
    /// 
    /// > Note: This method is implemented if the display server has the .nativeDialogInput feature. Supported platforms include macOS and Windows.
    /// 
    ...
    /// 
    /// > Note: This method is implemented if the display server has the .nativeDialogFile feature. Supported platforms include Linux (X11/Wayland), Windows, and macOS.
    /// 
    ...
    /// 
    /// > Note: Requires support for .nativeIcon.
    /// 
    ...
    /// 
    /// > Note: Requires support for .icon.
    /// 
