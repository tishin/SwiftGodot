...
open class DisplayServer: Object {
    ...
    public enum FileDialogMode: Int64, CaseIterable {
    ...
    public enum WindowMode: Int64, CaseIterable {
    ...
    public enum WindowFlags: Int64, CaseIterable {
    ...
    public enum HandleType: Int64, CaseIterable {
        /// Display handle:
        /// 
