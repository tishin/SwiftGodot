...
open class AudioServer: Object {
    ...
    public enum PlaybackType: Int64, CaseIterable {
    ...
    /// }
    /// ```
    public var busRenamed: SignalWithArguments<Int64, StringName, StringName> { SignalWithArguments<Int64, StringName, StringName> (target: self, signalName: "bus_renamed") }
