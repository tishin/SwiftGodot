...
open class NavigationRegion3D: Node3D {
    private static var className = StringName("NavigationRegion3D")
    ...
    public final func getRid() -> RID {
        ...
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_rid, handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_set_navigation_mesh: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("set_navigation_mesh")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
        ...
        withUnsafePointer(to: navigationMesh?.handle) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_navigation_mesh, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_navigation_mesh() -> NavigationMesh? {
        ...
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_navigation_mesh, handle, nil, &_result)
    ...
    fileprivate final func set_enabled(_ enabled: Bool) {
        ...
        withUnsafePointer(to: enabled) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_enabled, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_enabled() -> Bool {
        ...
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_is_enabled, handle, nil, &_result)
        return _result
    }
    ...
    public final func setNavigationMap(_ navigationMap: RID) {
        ...
        withUnsafePointer(to: navigationMap.content) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_navigation_map, handle, pArgs, nil)
                }
    ...
    public final func getNavigationMap() -> RID {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_navigation_map, handle, nil, &_result.content)
        return _result
    }
    
    fileprivate static let method_set_use_edge_connections: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("set_use_edge_connections")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2586408642)!
            }
    ...
    fileprivate final func set_use_edge_connections(_ enabled: Bool) {
        ...
        withUnsafePointer(to: enabled) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_use_edge_connections, handle, pArgs, nil)
                }
    ...
    fileprivate static let method_get_use_edge_connections: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_use_edge_connections")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 36873697)!
            }
    ...
    fileprivate final func get_use_edge_connections() -> Bool {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Bool = false
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_use_edge_connections, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_navigation_layers(_ navigationLayers: UInt32) {
        ...
        withUnsafePointer(to: navigationLayers) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_navigation_layers, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_navigation_layers() -> UInt32 {
        ...
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_navigation_layers, handle, nil, &_result)
        return _result
    }
            ...
            withUnsafePointer(to: value) { pArg1 in
                withUnsafePointer(to: UnsafeRawPointersN2(pArg0, pArg1)) { pArgs in
                    pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 2) { pArgs in
                        gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_navigation_layer_value, handle, pArgs, nil)
                    }
    ...
    public final func getNavigationLayerValue(layerNumber: Int32) -> Bool {
        ...
        withUnsafePointer(to: layerNumber) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_navigation_layer_value, handle, pArgs, &_result)
                }
    ...
    fileprivate static let method_get_region_rid: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_region_rid")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 2944877500)!
            }
    ...
    public final func getRegionRid() -> RID {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        let _result: RID = RID ()
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_region_rid, handle, nil, &_result.content)
        return _result
    }
    ...
    fileprivate final func set_enter_cost(_ enterCost: Double) {
        ...
        withUnsafePointer(to: enterCost) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_enter_cost, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_enter_cost() -> Double {
        ...
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_enter_cost, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_travel_cost(_ travelCost: Double) {
        ...
        withUnsafePointer(to: travelCost) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_set_travel_cost, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_travel_cost() -> Double {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_travel_cost, handle, nil, &_result)
        return _result
    }
    
    fileprivate static let method_bake_navigation_mesh: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("bake_navigation_mesh")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    public final func bakeNavigationMesh(onThread: Bool = true) {
        ...
        withUnsafePointer(to: onThread) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(NavigationRegion3D.method_bake_navigation_mesh, handle, pArgs, nil)
                }
    ...
    fileprivate static let method_is_baking: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("is_baking")
        return withUnsafePointer(to: &NavigationRegion3D.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 36873697)!
            }
    ...
    public final func isBaking() -> Bool {
        if handle == nil { Wrapped.attemptToUseObjectFreedByGodot() }
        var _result: Bool = false
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_is_baking, handle, nil, &_result)
        return _result
    }
    ...
    public final func getBounds() -> AABB {
        ...
        gi.object_method_bind_ptrcall(NavigationRegion3D.method_get_bounds, handle, nil, &_result)
        return _result
    }
