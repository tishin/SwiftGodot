...
open class VisualShaderNodeVec2Parameter: VisualShaderNodeParameter {
        ...
        withUnsafePointer(to: enabled) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(VisualShaderNodeVec2Parameter.method_set_default_value_enabled, handle, pArgs, nil)
                }
    ...
    fileprivate final func is_default_value_enabled() -> Bool {
        ...
        gi.object_method_bind_ptrcall(VisualShaderNodeVec2Parameter.method_is_default_value_enabled, handle, nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_default_value(_ value: Vector2) {
        ...
        withUnsafePointer(to: value) { pArg0 in
            withUnsafePointer(to: UnsafeRawPointersN1(pArg0)) { pArgs in
                pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 1) { pArgs in
                    gi.object_method_bind_ptrcall(VisualShaderNodeVec2Parameter.method_set_default_value, handle, pArgs, nil)
                }
    ...
    fileprivate final func get_default_value() -> Vector2 {
        ...
        gi.object_method_bind_ptrcall(VisualShaderNodeVec2Parameter.method_get_default_value, handle, nil, &_result)
        return _result
    }
