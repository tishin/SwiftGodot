...
open class EditorInspector: ScrollContainer {
    private static var className = StringName("EditorInspector")
    ...
    /// 
    public final func edit(object: Object?) {
    ...
    fileprivate static let method_get_selected_path: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("get_selected_path")
        return withUnsafePointer(to: &EditorInspector.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
    ...
    fileprivate static let method_instantiate_property_editor: GDExtensionMethodBindPtr = {
        var methodName = FastStringName("instantiate_property_editor")
        return withUnsafePointer(to: &EditorInspector.godotClassName.content) { classPtr in
            withUnsafePointer(to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind(classPtr, mnamePtr, 1429914152)!
            }
            ...
            withUnsafePointer(to: type.rawValue) { pArg1 in
                ...
                withUnsafePointer(to: path.content) { pArg2 in
                    withUnsafePointer(to: hint.rawValue) { pArg3 in
                        let hintText = GString(hintText)
                        withUnsafePointer(to: hintText.content) { pArg4 in
                            withUnsafePointer(to: usage) { pArg5 in
                                withUnsafePointer(to: wide) { pArg6 in
                                    withUnsafePointer(to: UnsafeRawPointersN7(pArg0, pArg1, pArg2, pArg3, pArg4, pArg5, pArg6)) { pArgs in
                                        pArgs.withMemoryRebound(to: UnsafeRawPointer?.self, capacity: 7) { pArgs in
                                            gi.object_method_bind_ptrcall(method_instantiate_property_editor, nil, pArgs, &_result)
                                        }
